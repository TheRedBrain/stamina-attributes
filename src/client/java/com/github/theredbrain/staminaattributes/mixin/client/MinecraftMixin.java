...
public class MinecraftMixin {
	...
	private void staminaattributes$startAttack_wrap_attackEntity(MultiPlayerGameMode instance, Player player, Entity target, Operation<Void> original) {
	...
	private boolean staminaattributes$startAttack_wrap_attackBlock(MultiPlayerGameMode instance, BlockPos pos, Direction direction, Operation<Boolean> original) {
	...
	private void staminaattributes$startAttack_wrap_swingHand(LocalPlayer instance, InteractionHand hand, Operation<Void> original) {
