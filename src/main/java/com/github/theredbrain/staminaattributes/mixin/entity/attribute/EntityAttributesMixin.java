...
public class EntityAttributesMixin {
    static {
        StaminaAttributes.STAMINA_REGENERATION = Registry.registerReference(Registries.ATTRIBUTE, StaminaAttributes.identifier("generic.stamina_regeneration"), new ClampedEntityAttribute("attribute.name.generic.stamina_regeneration", 10.0F, -1024.0F, 1024.0F).setTracked(true));
