...
public class EntityAttributesMixin {
    static {
        ...
        StaminaAttributes.MAX_STAMINA = Registry.registerReference(Registries.ATTRIBUTE, StaminaAttributes.identifier("generic.max_stamina"), new ClampedEntityAttribute("attribute.name.generic.max_stamina", 0.0F, 0.0F, 1024.0F).setTracked(true));
        StaminaAttributes.STAMINA_REGENERATION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, StaminaAttributes.identifier("generic.stamina_regeneration_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.stamina_regeneration_delay_threshold", 60.0F, 0.0F, 1024.0F).setTracked(true));
